...
ThemeData lightTheme = ThemeData(
  ...
  scaffoldBackgroundColor: $styles.colors.primary, // Basic light background
  appBarTheme: AppBarTheme(
    backgroundColor: Colors.lime, // Or $styles.colors.white
    foregroundColor: $styles.colors.greyLight, // Icons/text on appbar
    elevation: 0,
